...
export default function Hero() {
  return (
    <section className="relative z-1 mx-auto h-[clamp(35rem,50vw,55rem)] w-full max-w-480">
      ...
      <div className="absolute top-0 flex h-full w-full items-center justify-center">
        <div className="relative z-2 flex w-[clamp(27rem,40vw,36rem)] flex-col items-center">
          <h1 className="text-center text-6xl leading-18 font-black text-white max-xl:text-4xl max-xl:leading-12">
